...
/// Displays the GitHub device flow user code and polls for authorization.
///
...
impl DeviceAuthView {
    ...
    ///
    /// Initiates the GitHub device flow, builds the UI with the user code,
    ...
    pub fn new(hub: &Hub, context: &mut Context) -> Self {
        ...
        let view_id = ViewId::Ota(crate::view::ota::OtaViewId::DeviceAuth);
